    ...
    <main className="page">
      ...
      <section className="content">
        <header className="header">
          ...
          {/* Image — même placement/ratio que les autres fiches validées */}
          <div className="imgWrap">
            <img src="/boeuf.png" alt="Bœuf carottes & purée de pomme de terre" />
          </div>

          {/* Ligne info préparation / conservation (identique au pattern validé) */}
          <p className="desc">
          ...
          {/* Texte vendeur (même ton/longueur que bolo/moussaka) */}
          <p className="blurb">
            ...
            réconfortant, équilibré et plein de saveurs — idéal pour un repas sain
            et gourmand, à tout moment.
          </p>
        </header>

        {/* Grille 2–2–1 identique aux autres */}
        <div className="grid">
          {/* Ingrédients */}
          <section className="card">
            ...
            <ul className="ing">
              ...
              <li>Ail, oignon, herbes de Provence, poivre, sel</li>
            </ul>
        ...
        {/* Bloc cuisson / conservation (structure identique) */}
        <section className="card foot">
          ...
          <p className="note">
            La surgélation fige rapidement la fraîcheur et aide à préserver textures et nutriments, pour un goût au plus proche du fait-maison.
          </p>
        </section>
      </section>
...
.pill-diet{background:#fff4e6;border-color:#ffd7a6}
.imgWrap{margin:12px 0;border-radius:16px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,.06)}
...
.qty button{width:36px;height:36px;border-radius:10px;border:1px solid #ccd;font-size:18px;font-weight:700}
