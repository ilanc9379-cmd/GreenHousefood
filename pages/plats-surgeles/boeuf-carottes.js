      ...
      <section className="content">
        <header className="header">
          ...
          <figure className="hero">
            <img
              src="/boeuf.png"
              alt="Bœuf carottes & purée — visuel du plat"
              loading="eager"
            />
          </figure>
        ...
        <div className="grid">
          ...
          <section className="card">
            <h3>Ingrédients</h3>
            <ul className="ing">
              <li><b>200 g</b> — Purée de pomme de terre maison</li>
              <li><b>150 g</b> — Bœuf maigre (mijoté)</li>
              <li><b>150 g</b> — Carottes</li>
              <li>Oignon, ail, herbes de Provence, poivre</li>
              <li>Sel, <b>5 g</b> d’huile d’olive</li>
            </ul>
...
/* === Styles identiques à `bolo.js`, avec correctif du E visible === */
const styles = `
...
.hero img{width:100%;display:block;border-radius:14px;box-shadow:0 10px 24px rgba(0,0,0,.06);object-fit:cover}
