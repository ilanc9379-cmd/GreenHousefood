...
export default function BoeufCarottesPuree() {
  ...
  const nPortion = { kcal: 610, fat: 18, carbs: 48, protein: 48, salt: 2.1 };
  const n100 = {
    ...
    <main className="page">
      ...
      <section className="content">
        <header className="header">
          ...
          <p className="blurb">
            Une viande de bœuf fondante mijotée avec des <strong>carottes</strong> parfumées, servie
            avec une purée de pommes de terre onctueuse. Un classique réconfortant, équilibré et riche en protéines.
          </p>
        </header>
