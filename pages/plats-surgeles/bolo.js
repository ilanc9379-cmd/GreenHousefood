    ...
    <main className="wrap">
      ...
      <section className="sheet">
        <div className="sheet__head">
          ...
          <p className="meta">
            Portion : {portionGrams} g · <strong>Surgelé</strong> · prêt en <strong>20 min au four</strong> · riche en protéines
          </p>
          <p className="conserv">
        ...
        <div className="cols">
          ...
          {/* Ingrédients + Nutrition côte à côte */}
          <div className="panels">
            <div className="panel">
              ...
              <ul className="ing">
                ...
                <li><span>Sauce tomate maison</span><b>100 g</b></li>
...
.sheet__head h2{margin:.4rem 0 .2rem; font-size:clamp(26px,3.2vw,36px)}
