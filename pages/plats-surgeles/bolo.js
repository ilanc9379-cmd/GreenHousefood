...
export default function BoloSurgele() {
  // ===== Paramètres plat =====
  const NOM = "Pâtes bolognaise maison";
  const PRIX = 9.9;
  const POIDS = 600; // g (200 pâtes, 150 bœuf, 150 carottes, 100 sauce)
  // Macros par portion (à jour)
  const KCAL = 700, P = 54.3, G = 89, L = 15.8, SEL = 3, SUCRES = 11, AGS = +(L * 0.34).toFixed(1);
  ...
  const sucres100 = +(SUCRES / (POIDS / 100)).toFixed(1);
  const ags100 = +(AGS / (POIDS / 100)).toFixed(1);
    ...
    <>
      ...
      <main className="wrap">
        ...
        <article className="card">
          ...
          <p className="lead">
            Une bolognaise authentique sublimée par des <strong>pâtes au seigle artisanales</strong> (œufs plein air).
            Bœuf 5 % MG, carottes fondantes et sauce tomate maison pour un plat complet et équilibré.
          </p>
          ...
          <section className="grid2">
            <div className="panel">
              ...
              <h4>Ingrédients</h4>
              <ul className="ing">
                <li>Pâtes artisanales au seigle (œufs plein air) — 200 g</li>
                <li>Bœuf haché 5 % MG — 150 g</li>
                <li>Carottes — 150 g</li>
                <li>Sauce tomate — 100 g</li>
                <li>Aromates : ail, oignon, herbes, sel, poivre</li>
              </ul>
              <p className="muted">Allergènes : <b>gluten</b> (seigle, blé), <b>œufs</b>.</p>
            </div>
            ...
            <div className="panel">
              ...
              <table className="nutri">
                ...
                <tbody>
                  ...
                  <tr><td className="sub">dont acides gras saturés</td><td>{ags100} g</td><td>{AGS} g</td></tr>
                  <tr><td>Glucides</td><td>{g100} g</td><td>{G} g</td></tr>
                  <tr><td className="sub">dont sucres</td><td>{sucres100} g</td><td>{SUCRES} g</td></tr>
              ...
              <p className="note">
                La <b>surgélation</b> fige rapidement les aliments : elle aide à préserver les nutriments, la texture
                et le goût, tout en garantissant une excellente sécurité alimentaire.
              </p>
            </div>
          </section>
        </article>
