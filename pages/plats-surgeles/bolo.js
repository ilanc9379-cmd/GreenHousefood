    ...
    <main className="page">
      ...
      <section className="content">
        <header className="header">
          <img
            src="/images/plats-surgeles/pates-bolo.png"
...
const styles = `
.hero{width:100%;border-radius:16px;margin-bottom:16px;box-shadow:0 8px 20px rgba(0,0,0,.12)}
...
.brand{margin:0;font-size:48px;line-height:1;background:linear-gradient(90deg,#0aa64c,#2d7ae6);-webkit-background-clip:text;background-clip:text;color:transparent;font-weight:900}
.tag{color:#246}
