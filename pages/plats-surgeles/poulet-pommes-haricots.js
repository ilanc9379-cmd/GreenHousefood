...
export default function PouletPommesHaricots() {
  const NOM = "Cuisse de poulet rôtie, pommes de terre & haricots verts";
  const PRIX = 9.9;
  const POIDS = 550; // 1 cuisse ~250g cuite, 150g PDT rôties, 150g haricots
  // Estimations raisonnables (à ajuster si besoin)
  const KCAL = 640, P = 45, G = 48, L = 24, SEL = 2, SUCRES = 6, AGS = +(L * 0.33).toFixed(1);
    ...
    <>
      ...
      <main className="wrap">
        ...
        <article className="card">
          ...
          <p className="lead">
            Cuisse de poulet rôtie (marinade légère paprika fumé, moutarde à l’ancienne, ail, oignon),
            pommes de terre rôties aux épices et <strong>haricots verts frais</strong>.
          </p>
          ...
          <section className="grid2">
            <div className="panel">
              ...
              <h4>Ingrédients</h4>
              <ul className="ing">
                <li>Cuisse de poulet rôtie — env. 250 g</li>
                <li>Pommes de terre rôties — 150 g</li>
                <li>Haricots verts — 150 g</li>
                <li>Aromates : ail, oignon rouge, paprika, poivre, moutarde, huile d’olive</li>
              </ul>
              <p className="muted">Allergènes : <b>moutarde</b>.</p>
            </div>
            ...
            <div className="panel">
              ...
              <p className="note">
                Surgeler rapidement, c’est garder la qualité et la sécurité : nutriments, texture et goût mieux préservés.
              </p>
            </div>
          </section>
        </article>
