      ...
      <section className="content">
        <header className="header">
          ...
          <div className="heroImgWrap">
            <img src="/poulet-pommes-haricots.png" alt="Cuisse de poulet rôtie avec pommes de terre et haricots verts" className="heroImg" />
          </div>

          <p className="blurb">
            Une cuisse de <strong>poulet rôtie</strong> savoureuse, des <strong>pommes de terre fondantes</strong>
            et des <strong>haricots verts</strong> croquants. Simple, équilibré et réconfortant.
          </p>
        </header>
        ...
        <section className="card foot">
          ...
          <p className="note">La surgélation préserve fraîcheur et qualités nutritionnelles.</p>
        </section>
      </section>
