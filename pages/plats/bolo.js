  ...
  return (
    <>
        ...
        <div className="wrap">
          ...
          <section className="card conserve">
            ...
            <ul>
              ...
              <li>
                Après décongélation : <b>48 h au réfrigérateur</b>.
              </li>
              <li>
          ...
          <section className="card">
            ...
            <div className="tableWrap">
              <table className="nutri">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="sub">dont acides gras saturés</td>
                    <td>{ags100} g</td>
                    <td>{agsPortion} g</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td className="sub">dont sucres</td>
                    <td>{sucre100} g</td>
            ...
            <div className="macros">
              <div>
                ...
                <strong>{macroPct.p}%</strong>
                <span>des kcal</span>
              </div>
              <div>
                <small>Glucides</small>
                <strong>{macroPct.g}%</strong>
                <span>des kcal</span>
              </div>
              <div>
                <small>Lipides</small>
                <strong>{macroPct.l}%</strong>
                <span>des kcal</span>
              </div>
            </div>
          </section>
      ...
      <style jsx>{`
        ...
        /* Page background (dégradé animé très doux) */
        .page{
          min-height:100svh;
          background:
            ...
            linear-gradient(180deg, #f6fbff 0%, #f9fffb 70%, #ffffff 100%);
          color:var(--ink);
        }
        ...
        .brand{
          ...
          filter: drop-shadow(0 8px 24px rgba(45,122,230,.16));
        }
        ...
        .badge{
          ...
          border:1px solid rgba(0,0,0,.06); background:#eef5ff;
        }
        ...
        .qty input{
          width:120px;height:40px;border-radius:12px;border:1px solid rgba(0,0,0,.12);
          text-align:center;font-weight:600;
        }
        .totalLegend{color:var(--muted);margin-top:8px}
        .total{font-size:24px;font-weight:800}
        .cta{
          margin-top:12px;width:100%;height:44px;border:none;border-radius:12px;color:#fff;font-weight:800;cursor:pointer;
          background:linear-gradient(90deg,var(--brand1),var(--brand2));
        ...
        .ingList li{
          ...
          border:1px solid rgba(0,0,0,.06);padding:10px;border-radius:12px;
        }
        ...
        table.nutri{width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;border-radius:12px}
        .nutri thead th{
          background:#f0f4ff;border-bottom:1px solid rgba(0,0,0,.06);
          padding:10px;text-align:left;color:#334;
        }
        ...
        .macros > div{
          text-align:center;padding:10px;border-radius:12px;background:#fff;border:1px solid rgba(0,0,0,.06)
        }
