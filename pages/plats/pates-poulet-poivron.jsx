...
export default function PlatPouletPoivron() {
  // --------- Données (modifiables) ----------
  const PORTION_GRAMS = 600;         // 200 pâtes + 150 poulet + 100 sauce poivron + 150 julienne
  const PRICE_EUR = 9.9;

  // Totaux nutritionnels PAR PORTION (≈ issus de ton calcul)
  const NUTR_PORTION = {
    kcal: 689,
    lipides: 10,
    glucides: 86,
  ...
  return (
    <>
      <Head>
        <title>Pâtes émincé poulet & sauce poivron — GreenHouse</title>
        <meta name="description" content="Poulet tendre, sauce poivron maison, julienne de légumes." />
      </Head>
      ...
      <main className="wrap">
        ...
        <article className="sheet">
          <h2 className="h">Pâtes émincé poulet & sauce poivron</h2>
          <div className="chips">
          ...
          <p className="intro">
            Pâtes au seigle, émincé de poulet, sauce poivron maison (poivron,
            aromates, ail, oignon, sel, poivre) et julienne de légumes.
          </p>
          ...
          <div className="cols">
            ...
            <div className="card">
              ...
              <ul className="ing">
                <li><span>Pâtes de seigle (œufs plein air)</span><b>200 g</b></li>
                <li><span>Poulet émincé</span><b>150 g</b></li>
                <li><span>Sauce poivron maison</span><b>100 g</b></li>
...
const styles = `
/* même feuille de styles que 'bolo.js' pour cohérence */
${(() => {
  return `
  .wrap{
    min-height:100%;
